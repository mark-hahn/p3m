...
#define	intPinTRIS TRISC6
#define intPinIOCN IOCCN6
#define intPinIOCF IOCCF6 
...
#define INTCAPA  0x08  // pin values at time int event occured
...
#define swAll      (swTopLft|swBotLft|swTopRgt|swBotRgt|swHomeUp|swPwrOff)
